...
function Suggest() 
{
	...
	this.fetchMovie = function()
	{
		...
		{
			urlstr = "http://localhost/wt/sub/getmovies.php?moviepart=" + othis.movie.value;
			...
			else
			{
				...
				othis.xhr.open("GET", "http://localhost/wt/sub/getmovies.php?moviepart=" + othis.movie.value, true);
